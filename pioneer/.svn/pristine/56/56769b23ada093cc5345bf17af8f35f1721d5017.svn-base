package com.wellsys.pioneer.module.tSysJxs.service;
...
*/
public interface TSysJxsService {
	/****
	*
	* @Title: listBean
	...
	*/
	 ...
	 * @param  item 查询参数，存放主键信息。
 	 * @throws
	 */
	public TSysJxsModel getBeanById(TSysJxsModel item);
