package  com.wellsys.pioneer.module.tBaseYc.model;
...
public class TBaseYcModel implements java.io.Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6455087734509530275L;
	private String id="";
	private String area="";
