...
<script type="text/javascript">
 	    	var url = "/pages/module/tFormRight/";
...
/*		page.delDataGrid({
			formatURL : function(arr) {
				return contextPath + "/tFormRight/delete";
			},
	...
	page.onLoad = function() {
		...
		page.loadDataGrid({
			setOptions : function(opt) {
				opt.url = contextPath+"/tFormRight/"+"listByPage";
				opt.method = "get";
			}
		});
    ...
    function exportExcel() {// 方式一
        window.location.href = "${contextPath}/tFormRight/export";
	...
	<table id="datagrid" class="easyui-datagrid" style="min-height: 300px"
		...
		<thead>
            <tr>
                ...
                <th data-options="field:'formId',width:100,align:'left',halign:'center'">外键，表单id</th>
                <th data-options="field:'roleId',width:100,align:'left',halign:'center'">外键，角色id</th>
                <th data-options="field:'rightType',width:100,align:'left',halign:'center'">权限类型</th>
			</tr>
        </thead>	
    </table>
                </div>
