...
<script type="text/javascript">
 	    	var url = "/pages/module/tSysAreaUnite/";
...
/*		page.delDataGrid({
			formatURL : function(arr) {
				return contextPath + "/tSysAreaUnite/delete";
			},
	...
	page.onLoad = function() {
		...
		page.loadDataGrid({
			setOptions : function(opt) {
				opt.url = contextPath+"/tSysAreaUnite/"+"listByPage";
				opt.method = "get";
			}
		});
    ...
    function exportExcel() {// 方式一
        window.location.href = "${contextPath}/tSysAreaUnite/export";
	...
	<table id="datagrid" class="easyui-datagrid" style="min-height: 300px"
		...
		<thead>
            <tr>
                ...
                <th data-options="field:'careaId',width:100,align:'left',halign:'center'">功能区域id</th>
                <th data-options="field:'areaId',width:100,align:'left',halign:'center'">地区id</th>
			</tr>
        </thead>	
    </table>
                </div>
