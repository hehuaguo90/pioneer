...
<script type="text/javascript">
 	    	var url = "/pages/module/tSysUserRole/";
	    ...
	    var row = $('#datagrid').datagrid('getSelected');
	       page.editDataGrid({
			...
			formatURL : function(obj) {
				var params="";
                params+="userRoleId=" + obj.userRoleId;
...
/*		page.delDataGrid({
			formatURL : function(arr) {
				return contextPath + "/tSysUserRole/delete";
			},
	...
	page.onLoad = function() {
		...
		page.loadDataGrid({
			setOptions : function(opt) {
				opt.url = contextPath+"/tSysUserRole/"+"listByPage";
				opt.method = "get";
			}
		});
    ...
    function exportExcel() {// 方式一
        window.location.href = "${contextPath}/tSysUserRole/export";
	...
	<table id="datagrid" class="easyui-datagrid" style="min-height: 300px"
		...
		<thead>
            <tr>
                ...
                <th data-options="field:'userId',width:100,align:'left',halign:'center'">外键，用户Id</th>
			</tr>
        </thead>	
    </table>
                </div>
