package com.wellsys.pioneer.module.tSysDbRecord.service;
...
*/
public interface TSysDbRecordService {
	/****
	*
	* @Title: listBean
	...
	*/
	 ...
	 * @param  item 查询参数，存放主键信息。
 	 * @throws
	 */
	public TSysDbRecordModel getBeanById(TSysDbRecordModel item);
