package com.wellsys.pioneer.module.tSysJxxl.service;
...
*/
public interface TSysJxxlService {
	/****
	*
	* @Title: listBean
	...
	*/
	 ...
	 * @param  item 查询参数，存放主键信息。
 	 * @throws
	 */
	public TSysJxxlModel getBeanById(TSysJxxlModel item);
