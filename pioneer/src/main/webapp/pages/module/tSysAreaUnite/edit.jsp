...
<script type="text/javascript">
    page.onLoad = function() {
                page.send({
                    url : contextPath + "/tSysAreaUnite/getBeanById/?${pageContext.request.queryString}"
                }).then(function(data) {
                    //  item = kernel.json.parse(data);
                    page.loadForm({data:data });
                });

                //page.loadForm({url : contextPath + "/tSysAreaUnite/getBeanById/?${pageContext.request.queryString}"});
	...
	<jsp:body>
	<form method="post" action="${ contextPath }/tSysAreaUnite/edit">
        <table>
            <tr>
                <th>功能区域id:</th>
                <td>
