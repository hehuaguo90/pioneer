	...
	function del() {// 方式一
	   ...
	   page.delDataGrid({
            formatURL : function(arr) {
                return contextPath +"/tSysComp/"+"delete";
            },
	...
	page.onLoad = function() {
		...
		page.loadDataGrid({
			setOptions : function(opt) {
				opt.url = contextPath+"/tSysComp/"+"listByPage";
				opt.method = "get";
			}
		});
...
function search(evt) {
    page.loadDataGrid({
        setOptions : function(opt) {
            		opt.url = contextPath+"/tSysComp/"+"listByPage";
            		opt.method = "post";
					opt.queryParams.compName = $('#compName').val();
					opt.queryParams.compCode = $('#compCode').val();
	...
	<table id="datagrid" class="easyui-datagrid" style="min-height: 300px"
		...
		<thead>
            <tr>
                ...
                <th data-options="field:'compName',width:100,align:'left',halign:'center'">企业名称</th>
                <th data-options="field:'orgName',width:100,align:'left',halign:'center'">所属机构</th>
