...
<script type="text/javascript">
    page.onLoad = function() {
                page.send({
                    url : contextPath + "/tFormRight/getBeanById/?${pageContext.request.queryString}"
                }).then(function(data) {
                    //  item = kernel.json.parse(data);
                    page.loadForm({data:data });
                });

                //page.loadForm({url : contextPath + "/tFormRight/getBeanById/?${pageContext.request.queryString}"});
	...
	<jsp:body>
	<form method="post" action="${ contextPath }/tFormRight/edit">
        <table>
            <tr>
                <th>外键，表单id:</th>
                <td>
            ...
            <tr>
                ...
                <td>
                            ...
                            <input id="rightType" name="rightType"  type="text"
                                   style="width: 146px;"   class="easyui-validatebox textbox"
