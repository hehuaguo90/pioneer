...
page.onLoad = function() {
    page.send({
        url : contextPath + "/tSysArea/getBeanById/?${pageContext.request.queryString}"
    }).then(function(data) {
        ...
        if(pid==0){
        	...
        	$('#pid').combo('setText', '${param.areaName}')
        }
    });
};
...
$.extend($.fn.validatebox.defaults.rules, {  
	checkCode: {  
		validator: function (value, param) {  
		    var result = "";
	    	var parmfile = "areaCode="+value+"&thisAreaId="+$("#areaId").val();
			$.ajax({
		         async : false,  
		         type : 'post',  
	...
	<jsp:body>
	<form method="post" action="${ contextPath }/tSysArea/edit">
        ...
        <table class="default_form_input">
            ...
            <tr>
                ...
                <td>
                            ...
                            <input id="areaLevel" name="areaLevel"  
