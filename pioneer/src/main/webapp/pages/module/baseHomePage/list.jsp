	    ...
	    var row = $('#datagrid').datagrid('getSelected');
	       page.editDataGrid({
			...
			formatURL : function(obj) {
				...
				return contextPath+ "/pages/module/baseHomePage/edit.jsp?"+params;
			}
		});
	}
	page.onLoad = function() {
		...
		page.loadDataGrid({
			setOptions : function(opt) {
				opt.url = contextPath+"/tSysArea/anyWay?method=homePageListPage2";
				opt.method = "get";
			}
		});
	};
	...
	<table id="datagrid" class="easyui-datagrid" style="min-height: 300px"
		...
		<thead>
            <tr>
                ...
                <th
								data-options="field:'NAME99',width:200,align:'left',halign:'center'">地区</th>
                <th
								data-options="field:'INFO',width:150,align:'left',halign:'center',formatter:view">信息</th>
			</tr>
        </thead>	
    </table>
    </div>
