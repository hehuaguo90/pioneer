...
class RandomValidateCode {
	 public static final String RANDOMCODEKEY = "validateCodeImage";//放到session中的key
   private Random random = new Random();
   private String randString = "23456789ABCDEFGHJKLMNPQRSTUVWXYZ";//随机产生的字符串，已除去数字0、1和字母O、I
