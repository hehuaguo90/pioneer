package com.wellsys.pioneer.module.tSysAreaUnite.service;
...
*/
public interface TSysAreaUniteService {
	/****
	*
	* @Title: listBean
	...
	*/
	 ...
	 * @param  item 查询参数，存放主键信息。
 	 * @throws
	 */
	public TSysAreaUniteModel getBeanById(TSysAreaUniteModel item);
