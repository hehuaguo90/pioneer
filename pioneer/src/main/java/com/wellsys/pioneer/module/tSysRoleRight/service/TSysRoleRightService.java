package com.wellsys.pioneer.module.tSysRoleRight.service;
...
*/
public interface TSysRoleRightService {
	/****
	*
	* @Title: listBean
	...
	*/
	 ...
	 * @param  item 查询参数，存放主键信息。
 	 * @throws
	 */
	public TSysRoleRightModel getBeanById(TSysRoleRightModel item);
